...
def add_arguments(parser):
  ...
  parser.add_argument("--encoder_type", type=str, default="uni", help="""\
      ...
      Based on the requirement in the assignment, we use the uni without 
        implementing the bi as well as gnmt model in order to simplify the
        total model and reduce the total length of code files.\
      """)
  ...
  parser.add_argument("--attention", type=str, default="luong", help="""\
      ...
      attention\
      In our assignment, we use luong according to the given sample in the requirement\
      """)
  parser.add_argument(
      ...
      We eliminated the gnmt and gnmt_v2 as the same reason in the nmt.py line 62\
      """)
  parser.add_argument(
  ...
  parser.add_argument("--src", type=str, default="en",
                      help="Source suffix, e.g., en. Here we use en (English).")
  parser.add_argument("--tgt", type=str, default="zh",
                      help="Target suffix, e.g., de. Here we use zh (Chinese).")
  parser.add_argument("--train_prefix", type=str, default="./data/train",
                      help="Train prefix, expect files with src/tgt suffixes.")
  parser.add_argument("--dev_prefix", type=str, default="./data/dev",
  ...
  # Vocab
  parser.add_argument("--vocab_prefix", type=str, default="./data/vocab", help="""\
